#############################################################################
# Makefile for building: qtFlashBuilder.app/Contents/MacOS/qtFlashBuilder
# Generated by qmake (3.0) (Qt 5.7.0)
# Project:  qtFlashBuilder.pro
# Template: app
# Command: /Users/grzegorz/Qt/5.7/clang_64/bin/qmake -spec macx-clang CONFIG+=x86_64 -o Makefile qtFlashBuilder.pro
#############################################################################
...
CFLAGS        = -pipe -O2 -isysroot /Applications/Xcode.app/Contents/Developer/Platforms/MacOSX.platform/Developer/SDKs/MacOSX13.1.sdk -mmacosx-version-min=10.8 -Wall -W -fPIC $(DEFINES)
CXXFLAGS      = -pipe -stdlib=libc++ -O2 -std=gnu++11 -isysroot /Applications/Xcode.app/Contents/Developer/Platforms/MacOSX.platform/Developer/SDKs/MacOSX13.1.sdk -mmacosx-version-min=10.8 -Wall -W -fPIC $(DEFINES)
INCPATH       = -I. -I../../Qt/5.7/clang_64/lib/QtWidgets.framework/Headers -I../../Qt/5.7/clang_64/lib/QtGui.framework/Headers -I../../Qt/5.7/clang_64/lib/QtCore.framework/Headers -I. -I/Applications/Xcode.app/Contents/Developer/Platforms/MacOSX.platform/Developer/SDKs/MacOSX13.1.sdk/System/Library/Frameworks/OpenGL.framework/Headers -I/Applications/Xcode.app/Contents/Developer/Platforms/MacOSX.platform/Developer/SDKs/MacOSX13.1.sdk/System/Library/Frameworks/AGL.framework/Headers -I. -I../../Qt/5.7/clang_64/mkspecs/macx-clang -F/Users/grzegorz/Qt/5.7/clang_64/lib
...
TAR           = tar -cf
COMPRESS      = gzip -9f
DISTNAME      = qtFlashBuilder1.0.0
DISTDIR = /Users/grzegorz/QtProjekty/qtFlashBuilder/.tmp/qtFlashBuilder1.0.0
LINK          = /Applications/Xcode.app/Contents/Developer/Toolchains/XcodeDefault.xctoolchain/usr/bin/clang++
LFLAGS        = -headerpad_max_install_names -stdlib=libc++ -Wl,-syslibroot,/Applications/Xcode.app/Contents/Developer/Platforms/MacOSX.platform/Developer/SDKs/MacOSX13.1.sdk -mmacosx-version-min=10.8 -Wl,-rpath,/Users/grzegorz/Qt/5.7/clang_64/lib
...
SOURCES       = main.cpp \
		mainwindow.cpp qrc_qtFlashBuilder.cpp \
		moc_mainwindow.cpp
OBJECTS       = main.o \
		mainwindow.o \
		qrc_qtFlashBuilder.o \
		moc_mainwindow.o
DIST          = ../../Qt/5.7/clang_64/mkspecs/features/spec_pre.prf \
		...
		qtFlashBuilder.pro mainwindow.h main.cpp \
		mainwindow.cpp
QMAKE_TARGET  = qtFlashBuilder
DESTDIR       = 
TARGET        = qtFlashBuilder.app/Contents/MacOS/qtFlashBuilder
...
$(TARGET): ui_mainwindow.h $(OBJECTS)  
	@test -d qtFlashBuilder.app/Contents/MacOS/ || mkdir -p qtFlashBuilder.app/Contents/MacOS/
	$(LINK) $(LFLAGS) -o $(TARGET) $(OBJECTS) $(OBJCOMP) $(LIBS)

Makefile: qtFlashBuilder.pro ../../Qt/5.7/clang_64/mkspecs/macx-clang/qmake.conf ../../Qt/5.7/clang_64/mkspecs/features/spec_pre.prf \
		../../Qt/5.7/clang_64/mkspecs/qdevice.pri \
		../../Qt/5.7/clang_64/mkspecs/features/device_config.prf \
		../../Qt/5.7/clang_64/mkspecs/common/unix.conf \
		../../Qt/5.7/clang_64/mkspecs/common/mac.conf \
	...
	$(QMAKE) -spec macx-clang CONFIG+=x86_64 -o Makefile qtFlashBuilder.pro
...
qtFlashBuilder.app/Contents/PkgInfo: 
	@test -d qtFlashBuilder.app/Contents || mkdir -p qtFlashBuilder.app/Contents
	@$(DEL_FILE) qtFlashBuilder.app/Contents/PkgInfo
	@echo "APPL????" > qtFlashBuilder.app/Contents/PkgInfo
qtFlashBuilder.app/Contents/Resources/empty.lproj: 
	@test -d qtFlashBuilder.app/Contents/Resources || mkdir -p qtFlashBuilder.app/Contents/Resources
	@touch qtFlashBuilder.app/Contents/Resources/empty.lproj
	
qtFlashBuilder.app/Contents/Info.plist: 
	@test -d qtFlashBuilder.app/Contents || mkdir -p qtFlashBuilder.app/Contents
	@$(DEL_FILE) qtFlashBuilder.app/Contents/Info.plist
	@sed -e "s,@SHORT_VERSION@,1.0,g" -e "s,@FULL_VERSION@,1.0.0,g" -e "s,@TYPEINFO@,????,g" -e "s,@BUNDLEIDENTIFIER@,RIOT.qtFlashBuilder,g" -e "s,@ICON@,qtFlashBuilder.icns,g" -e "s,@EXECUTABLE@,qtFlashBuilder,g" -e "s,@LIBRARY@,qtFlashBuilder,g" -e "s,@TYPEINFO@,????,g" ../../Qt/5.7/clang_64/mkspecs/macx-clang/Info.plist.app >qtFlashBuilder.app/Contents/Info.plist
qtFlashBuilder.app/Contents/Resources/qtFlashBuilder.icns: qtFlashBuilder.icns
	@test -d qtFlashBuilder.app/Contents/Resources/ || mkdir -p qtFlashBuilder.app/Contents/Resources/
	@$(DEL_FILE) qtFlashBuilder.app/Contents/Resources/qtFlashBuilder.icns
	@$(COPY_FILE) qtFlashBuilder.icns qtFlashBuilder.app/Contents/Resources/qtFlashBuilder.icns

all: Makefile \
		qtFlashBuilder.app/Contents/PkgInfo \
		qtFlashBuilder.app/Contents/Resources/empty.lproj \
		qtFlashBuilder.app/Contents/Info.plist \
		qtFlashBuilder.app/Contents/Resources/qtFlashBuilder.icns $(TARGET)
...
distdir: FORCE
	...
	$(COPY_FILE) --parents qtFlashBuilder.qrc $(DISTDIR)/
...
compiler_rcc_make_all: qrc_qtFlashBuilder.cpp
compiler_rcc_clean:
	-$(DEL_FILE) qrc_qtFlashBuilder.cpp
qrc_qtFlashBuilder.cpp: qtFlashBuilder.qrc \
		../../Qt/5.7/clang_64/bin/rcc \
		qtFlashBuilder.png
	/Users/grzegorz/Qt/5.7/clang_64/bin/rcc -name qtFlashBuilder qtFlashBuilder.qrc -o qrc_qtFlashBuilder.cpp
...
moc_mainwindow.cpp: ../../Qt/5.7/clang_64/lib/QtWidgets.framework/Headers/QMainWindow \
	...
	/Users/grzegorz/Qt/5.7/clang_64/bin/moc $(DEFINES) -D__APPLE__ -D__GNUC__=4 -D__APPLE_CC__ -I/Users/grzegorz/Qt/5.7/clang_64/mkspecs/macx-clang -I/Users/grzegorz/QtProjekty/qtFlashBuilder -I/Users/grzegorz/Qt/5.7/clang_64/lib/QtWidgets.framework/Headers -I/Users/grzegorz/Qt/5.7/clang_64/lib/QtGui.framework/Headers -I/Users/grzegorz/Qt/5.7/clang_64/lib/QtCore.framework/Headers -I/usr/local/include -I/Applications/Xcode.app/Contents/Developer/Platforms/MacOSX.platform/Developer/SDKs/MacOSX.sdk/usr/include/c++/v1 -I/Applications/Xcode.app/Contents/Developer/Toolchains/XcodeDefault.xctoolchain/usr/lib/clang/14.0.0/include -I/Applications/Xcode.app/Contents/Developer/Platforms/MacOSX.platform/Developer/SDKs/MacOSX.sdk/usr/include -I/Applications/Xcode.app/Contents/Developer/Toolchains/XcodeDefault.xctoolchain/usr/include -I'/Applications/Xcode.app/Contents/Developer/Platforms/MacOSX.platform/Developer/SDKs/MacOSX.sdk/System/Library/Frameworks (framework directory)' -F/Users/grzegorz/Qt/5.7/clang_64/lib mainwindow.h -o moc_mainwindow.cpp
...
qrc_qtFlashBuilder.o: qrc_qtFlashBuilder.cpp 
	$(CXX) -c $(CXXFLAGS) $(INCPATH) -o qrc_qtFlashBuilder.o qrc_qtFlashBuilder.cpp
